class Game {
  ...
  async start(){
    ...
    p3 = createSprite(900,200);
    p3.addAnimation("p3",p3_Img);
    p3.pointTo(100, 200);
    p3.mirrorY(-1);
    p4 = createSprite(900,200);
  ...
  play(){
    ...
    // p3.x = 350 - allPlayers[plr].distance;
  
   // p3.y =50 + (index * 150) + allPlayers[plr].xPos ;;
  
    //    gun3.x =  500 - allPlayers[plr].distance;
      //  gun3.y = 50 -(index * 100) + allPlayers[plr].xPos ;
    ...
    if(keyIsDown(38) && player.index === 1){
      yVel+=0.9;
      if(keyIsDown(37)){
        xVel -= 0.2;
  ...
  }else if(keyIsDown(38) && yVel > 0 && player.index=== 1){
      yVel -= 0.1;
      xVel *= 0.9;
  ...
  if(keyIsDown(38) && player.index === 2){
    yVel+=0.9;
    if(keyIsDown(37)){
      xVel -= 0.2;
...
}else if(keyIsDown(38) && yVel > 0 && player.index=== 2){
    yVel -= 0.1;
    xVel *= 0.9;
...
if(keyIsDown(38) && player.index === 3){
  yVel+=0.9;
  if(keyIsDown(37)){
    xVel -= 0.2;
...
}else if(keyIsDown(38) && yVel > 0 && player.index=== 3){
  yVel -= 0.1;
  xVel *= 0.9;
...
if(keyIsDown(38) && player.index === 4){
  yVel-=0.9;
  if(keyIsDown(37)){
    xVel += 0.2;
...
}else if(keyIsDown(38) && yVel > 0 && player.index=== 4){
  yVel += 0.1;
  xVel *= 0.9;
